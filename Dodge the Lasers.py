...
def compute(n):
    if n == 0:
        return 0
    sqrt_2_under_100 = 4142135623730950488016887242096980785696718753769480731766797379907324784621070388503875343276415727
    divider = 10 ** 100
    np = sqrt_2_under_100 * n // divider
    return n * np + n * (n+1)//2 - np * (np + 1)//2 - compute(np)

def solution(str_n):
    n = int(str_n)
    return str(compute(n))
